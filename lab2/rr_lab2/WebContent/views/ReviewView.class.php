		...
		<form method="post">
			<section>
				<h1>fliX Reviews</h1>
					...
					Reviewed On <input type="month" name="reviewedOn" <?php if (!is_null($reviewData)) { echo 'value = "'. $reviewData->getReviewedOn() .'"'; }?> tabindex="16"> <?php if (!is_null($reviewData)) {echo $reviewData->getError('reviewedOn');}?><br><br>
